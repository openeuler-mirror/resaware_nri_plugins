...
import (
	...
	"numaadj.huawei.com/pkg/generated/clientset/versioned/scheme"
)
...
// ResourceV1alpha1Client is used to interact with features provided by the resource.sop.huawei.com group.
type ResourceV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ResourceV1alpha1Client) Oenumas(namespace string) OenumaInterface {
	return newOenumas(c, namespace)
}

func (c *ResourceV1alpha1Client) Whitelists(namespace string) WhitelistInterface {
	return newWhitelists(c, namespace)
}
